...
<div class="col-sm-12 col-md-12">
    <form method="POST" action="{{ url('owners/'. $owner->slug .'/categories') }}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <select required class="form-control @error('unit_id') is-invalid @enderror" name="unit_id" id="unit_id">
                    ...
                    <option @if(old('unit') == $unit->id) selected @endif value="{{ $unit->id }}">
        ...
        <div class="form-group row mb-0">
            <div class="col-md-6 offset-md-4">
                ...
                <a href="{{ url('owners/'. $owner->slug .'/categories') }}" class="btn btn-warning">
                    Volver
                </a>
            </div>
        </div>
