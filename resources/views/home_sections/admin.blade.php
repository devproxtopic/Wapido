        ...
        <div class="card card-small blog-comments">
            ...
            <div class="blog-comments__item d-flex p-3">
                ...
                <div class="blog-comments__actions">
                    <a href="{{ route('owner.enable.orders', $owner->id) }}" class="btn btn-sm btn-white {{ ($owner->order_enabled == 1) ? 'active' : '' }}">
                    ...
                    <a href="{{ route('owner.enable.reservations', $owner->id) }}" class="btn btn-sm btn-white {{ ($owner->reservations_enabled == 1) ? 'active' : '' }}">
                        <span class="text-dark">
                        <i class="material-icons">edit</i>
                        </span> Reservaciones
                    </a>
                    <a href="{{ route('owner.enable.main_digital', $owner->id) }}" class="btn btn-sm btn-white {{ ($owner->main_digital_enabled == 1) ? 'active' : '' }}">
