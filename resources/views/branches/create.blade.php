...
<div class="col-sm-12 col-md-12">
    <form method="POST" action="{{ url('owners/'. $owner->slug .'/branches') }}">
        @csrf
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <select required class="form-control @error('location_id') is-invalid @enderror" name="location_id" id="location_id">
                    {{-- SE LLENA CON AJAX--}}
                </select>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                ...
                id="address" cols="30" rows="10">{{ old('address') }}</textarea>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input id="ubication_google_maps" type="text" class="form-control @error('ubication_google_maps') is-invalid @enderror" name="ubication_google_maps" value="{{ old('ubication_google_maps') }}" required autocomplete="ubication_google_maps" autofocus>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input id="quantity_people" type="text" class="form-control @error('quantity_people') is-invalid @enderror" name="quantity_people" value="{{ old('quantity_people') }}" required autocomplete="quantity_people" autofocus>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input id="quantity_tables" type="text" class="form-control @error('quantity_tables') is-invalid @enderror" name="quantity_tables" value="{{ old('quantity_tables') }}" required autocomplete="quantity_tables" autofocus>
