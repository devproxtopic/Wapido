                ...
                <table cellspacing="0" cellpadding="0" class="force-full-width">
                  <tr>
                    ...
                    <div class="mobile-br">&nbsp;</div>
                      Has recibido una nueva reservación.
                    <br>
                    </td>
                  </tr>
                </table>
                    ...
                    <table style="margin:0 auto;" cellspacing="0" cellpadding="0" class="force-width-80">
                        <tr>
                                <td style="font-size:16px; font-weight: 600; color:#6f6f6f; text-align:center;" class="mobile-spacing">
                                    Hola {{ $reservation->owner->name }}, has recibido una nueva reservación {{ $reservation->id }}
                                    <br>
                                    de {{ $reservation->client->fullname }} / WhatsApp # {{ $reservation->client->phone }} <br>
                                </td>
                        </tr>
                    </table>
                </center>
