...
@section('title', 'Crear Paises Másivos')
@section('display_create', 'display:none;')

@section('content')
<div class="col-sm-12 col-md-12">
    <form method="POST" action="{{ url('owners/'. $owner->slug .'/countries-massive') }}" enctype="multipart/form-data">
        @csrf
...
@section('scripts')
<script src="{{ asset('js/ajax/countries.js') }}"></script>
@stop
