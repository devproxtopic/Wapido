<aside class="main-sidebar col-12 col-md-3 col-lg-2 px-0">
    ...
    <nav class="navbar align-items-stretch navbar-light bg-white flex-md-nowrap border-bottom p-0">
        <a class="navbar-brand w-100 mr-0" href="{{ isset($owner) ? url('owner/'.$owner->id) : '#' }}" style="line-height: 25px;">
    ...
    <ul class="nav flex-column">
        <li class="nav-item {{ (request()->segment(3) == 'stats') ? 'active' : '' }}">
            <a class="nav-link" href="{{ url('owners/'.$owner->slug.'/stats') }}">
