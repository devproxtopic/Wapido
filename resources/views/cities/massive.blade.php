...
@section('title', 'Crear Ciudades Másivas')
@section('display_create', 'display:none;')

@section('content')
<div class="col-sm-12 col-md-12">
    <form method="POST" action="{{ url('owners/'. $owner->slug .'/cities-massive') }}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-group row mb-0">
            <div class="col-md-6 offset-md-4">
                ...
                <a href="{{ url('owners/'. $owner->slug .'/cities') }}" class="btn btn-warning">
                    Volver
                </a>
            </div>
        </div>
...
@section('scripts')
<script src="{{ asset('js/ajax/cities.js') }}"></script>
@stop
